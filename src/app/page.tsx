...
import React, { useState, useEffect, type ReactNode, ChangeEvent, FormEvent } from 'react';
...
export default function Home() {
  ...
  const handleDemoRequest = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    setIsLoading(true);
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSubmitStatus('error');
        setSubmitMessage(
          `Sorry, there was an error sending your message. Please try again or contact us directly. Status code: ${response.status}`
        );
      }
    } catch (error) {
  ...
  return (
    <main>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              gtag('js', new Date());
              gtag('config', 'G-2D18CMVZEF'); </script>
            `,
          }}
        />
      </Head>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Replace unpredictable transaction fees with a fixed monthly rate. Each plan includes one complete POS
                      system with all hardware and software.
                    </p>
                    <p className="mt-1 text-xs text-gray-500">
                      *Custom and enterprise configurations available. Contact us for multi-terminal and multi-location
                      pricing and specific business needs.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex-grow">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <motion.li key={index} className="flex items-center text-gray-600">
      ...
      <section id="solutions" className="py-20 bg-gradient-to-b from-white to-gray-50"></section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <p className="max-w-2xl mx-auto text-lg text-gray-600">
              Ready to transform your business? Fill out the form below and a local team member will get back to you
              within 24 hours.
            </p>
          </div>
              ...
              <form onSubmit={handleDemoRequest} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="retailorcounterservicerestaurantbundle">
                      Retail or Counter-Service Restaurant Bundle
                    </option>
                ...
                <div className="space-y-4">
                  ...
                  {submitStatus === 'success' && (
                    <div className="p-4 text-green-600 rounded-lg bg-green-50">{submitMessage}</div>
                  )}

                  {submitStatus === 'error' && (
                    <div className="p-4 text-red-600 rounded-lg bg-red-50">{submitMessage}</div>
                  )}
