...
<div className="p-8 bg-white border border-gray-100 shadow-sm rounded-xl">
  <form action="https://formspree.io/f/mzzzyddy" method="POST" className="space-y-6">
    ...
    <div className="space-y-4">
      <button
        type="submit"
        className="w-full py-4 px-6 rounded-lg font-semibold text-white bg-blue-600 hover:bg-blue-700 hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300"
      >
        Send Message
      </button>
    </div>
